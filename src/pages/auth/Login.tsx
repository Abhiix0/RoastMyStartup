        ...
        <RetroUICard>
          <RetroUICardHeader>
            <RetroUICardTitle className="text-3xl md:text-4xl text-center mb-2">
              Welcome back. Ready for more pain?
            </RetroUICardTitle>
          </RetroUICardHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <RetroUIButton
                  variant="secondary"
                  className="w-full flex items-center justify-center gap-3"
                  onClick={() => console.log("GitHub OAuth (UI only)")}
                >
              ...
              <div className="space-y-3">
                ...
                <RetroUIButton
                  variant="default"
                  className="w-full"
                  onClick={() => console.log("Login (UI only)")}
                >
                  Login
                </RetroUIButton>
              </div>
              ...
              <div className="text-center text-sm space-y-2 pt-2">
                <p className="font-medium">
                  ...
                  <Link to="/auth/signup" className="font-bold underline hover:text-yellow-600">
                    Sign up
                  </Link>
                </p>
                <p>
